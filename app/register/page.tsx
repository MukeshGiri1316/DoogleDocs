  ...
  return (
    <div className="flex flex-1 items-center justify-center px-4 page-enter">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-96 w-96 rounded-full bg-accent/15 blur-[120px]" />
      </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-xl shadow-black/20">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative space-y-2">
              ...
              <span className="absolute bottom-0 right-2 text-xs text-accent cursor-pointer" onClick={() => setIsVisible(!isVisible)}>{isVisible ? "Hide" : "Show"}</span>
            </div>
